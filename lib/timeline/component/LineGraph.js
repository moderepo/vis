...
>>>>>>> master
    ...
    /// [MODE change] ... or not, because this unexpectedly causes exceptions
    /* var existingItemsMap = {};
<<<<<<< HEAD
>>>>>>> fe6fce1d... Replay commits in mode-vis to this repository
=======
>>>>>>> master
    if (!groupIds && ids) {
...
LineGraph.prototype._updateGraph = function () {
  ...
  if (this.props.width != 0 && this.itemsData != null) {
    ...
    if (groupIds.length > 0) {
      ...
      /// [MODE change] remove this "optimization" so graph doesn't disappear when zooming in/out in browser
