...
CustomTime.prototype.setOptions = function(options) {
  if (options) {
    ...
    util.selectiveExtend(['moment', 'locale', 'locales', 'id', 'enableIcon', 'onClickIcon'], this.options, options);
  }
};
...
CustomTime.prototype._create = function() {
  ...
  // showIcon is Promise to allow delayed check for video data.
  if (this.options.enableIcon && this.tag && this.tag.showIcon) {
    this.tag.showIcon().then( res => {
      if (res) {
        // custom icon
        ...
        if (this.options.onClickIcon) {
          icon.addEventListener("click", () => { this.options.onClickIcon(this.tag); }, false);
        }
